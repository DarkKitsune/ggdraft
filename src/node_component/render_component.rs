...
impl RenderComponent {
    ...
    pub fn new(render: fn(&Node, &TargetBuffer, Vector2<u32>, &RenderCamera, &mut GfxCache)) -> Self {
        Self { render }
    }
    ...
    pub fn render(&self, node: &Node, target_buffer: &TargetBuffer, buffer_size: Vector2<u32>, camera: &RenderCamera, render_children: bool, cache: &mut GfxCache, universe: Option<&Universe>) {
        ...
        if render_children {
            if let Some(universe) = universe {
                    ...
                    .with_component::<RenderComponent>()
                {
                    ...
                    render_component.render(child, target_buffer, buffer_size, camera, true, cache, Some(universe));
                }
            }
        }
